...
// These are supplemental pages only. Canonical calculator routes are generated from the calculator registries.
// Legacy aliases such as /calorie-calculator and /army-body-fat-calculator are intentionally not prerendered here;
// Vercel permanently redirects them to their canonical targets.
const pages = [
  ...
  {slug:"calories-burned-calculator",title:"Calories Burned Calculator",description:"Estimate energy expenditure for a 30-minute activity using body weight and an activity intensity estimate.",formula:"Calories ≈ MET × 3.5 × body weight (kg) ÷ 200 × minutes",links:["/tdee-calculator","/daily-calorie-needs-calculator"]},
  ...
  {slug:"carbohydrate-calculator",title:"Carbohydrate Calculator",description:"Estimate a daily carbohydrate target after accounting for protein and fat within estimated calorie needs.",formula:"Carbohydrate grams = remaining calories ÷ 4",links:["/macro-calculator","/daily-calorie-needs-calculator"]},
  {slug:"fat-intake-calculator",title:"Fat Intake Calculator",description:"Estimate a daily dietary fat target from estimated maintenance calories.",formula:"Fat grams = target calories × 25% ÷ 9",links:["/macro-calculator","/daily-calorie-needs-calculator"]},
  {slug:"one-rep-max-calculator",title:"One Rep Max Calculator",description:"Estimate your one-repetition maximum from a weight and repetition set using a common strength-training equation.",formula:"Epley estimate: 1RM = weight × (1 + repetitions ÷ 30)",links:["/strength-level-calculator","/training-volume-calculator"]},
...
console.log(`Prerendered ${pages.length} supplemental calculator pages plus editorial/evidence pages.`);
