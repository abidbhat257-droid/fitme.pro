...
(async()=>{
  try{
    ...
    // Expansion articles are kept when a slug exists in both sources; otherwise
    // the original article is retained. Every article is then converted into
    // the long-form format before its SEO HTML is written to build/.
