...
function forceTop() {
  const reset = () => { window.scrollTo(0, 0); document.documentElement.scrollTop = 0; document.body.scrollTop = 0; if (document.scrollingElement) document.scrollingElement.scrollTop = 0; };
  reset(); requestAnimationFrame(reset); setTimeout(reset, 0); setTimeout(reset, 100); setTimeout(reset, 300);
}
