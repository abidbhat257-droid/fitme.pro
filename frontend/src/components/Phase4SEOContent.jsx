...
export default function Phase4SEOContent({ slug }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <section><h3 className="font-display text-xl sm:text-2xl uppercase tracking-tight mb-3">Formula or Method</h3><p className="text-sm sm:text-base text-muted-foreground leading-relaxed font-mono">{data.formula}</p><p className="mt-3 text-sm sm:text-base text-muted-foreground leading-relaxed">{data.method}</p></section>
      ...
      <section><h3 className="font-display text-xl sm:text-2xl uppercase tracking-tight mb-3">What Your Result Means</h3><p className="text-sm sm:text-base text-muted-foreground leading-relaxed">{data.meaning}</p></section>
