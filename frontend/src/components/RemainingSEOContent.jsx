...
export default function RemainingSEOContent({ calc }) {
  ...
  return (
    <div className="space-y-8">
      ...
      <section><h3 className="font-display text-xl sm:text-2xl uppercase tracking-tight mb-3">How It Is Calculated</h3><p className="text-sm sm:text-base text-muted-foreground leading-8">The calculator validates the required inputs, applies the implemented equation or method, and formats the resulting value for display. When a prediction equation is used, the output is an estimate rather than a direct laboratory or clinical measurement.</p></section>
