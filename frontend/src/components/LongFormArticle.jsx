...
const PHASE6_SEO_SLUGS = new Set(["weight-change", "weight-loss-timeline", "goal-weight-date", "weekly-weight-loss", "calories-to-lose-1-kg"]);
...
export default function LongFormArticle({ content, calc }) {
  ...
  const hasDedicatedSEO = isDedicatedComposition || isDedicatedPhase1 || isDedicatedPhase2 || isDedicatedPhase3 || isDedicatedPhase4 || isDedicatedPhase5 || isDedicatedPhase6 || calc?.slug === "bmi";
  ...
  return (
    <article className="border-t border-border pt-10 mt-2 space-y-8" data-testid="long-form-seo-content">
      ...
      {!isDedicatedPhase2 && !isDedicatedPhase3 && !isDedicatedPhase4 && !isDedicatedPhase5 && !isDedicatedPhase6 && isDedicatedComposition && <CompositionSEOContent slug={calc.slug} />}
