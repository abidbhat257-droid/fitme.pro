  ...
  return (
    <footer className="no-print border-t border-border bg-background/60 mt-16">
      <div className="mx-auto max-w-[1600px] px-4 sm:px-8 py-10 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div><div className="text-[10px] font-bold uppercase tracking-[0.25em] text-muted-foreground mb-3">Information</div><div className="flex flex-col gap-2 text-xs"><Link to="/about" className="hover:underline">About FitMe Pro</Link><Link to="/contact" className="hover:underline">Contact</Link><Link to="/terms" className="hover:underline">Terms & Conditions</Link></div></div>
      </div>
