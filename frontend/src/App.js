...
function App() {
  return <div className="App"><ThemeProvider><MeasurementProvider><BrowserRouter><ScrollToTop /><Header /><Routes>
    ...
    <Route path="/carbohydrate-calculator" element={<SpecializedCalculatorPage />} /><Route path="/fat-intake-calculator" element={<SpecializedCalculatorPage />} /><Route path="/one-rep-max-calculator" element={<SpecializedCalculatorPage />} /><Route path="/target-heart-rate-calculator" element={<SpecializedCalculatorPage />} /><Route path="/army-body-fat-calculator" element={<SpecializedCalculatorPage />} />
