...
function App() { return <div className="App"><ThemeProvider><MeasurementProvider><BrowserRouter><ScrollManager /><Sidebar /><Header /><Routes>
  ...
  <Route path="/journal" element={<Journal />} /><Route path="/journal/editorial-standards" element={<EditorialStandards />} /><Route path="/journal/:categorySlug" element={<JournalCategory />} /><Route path="/journal/:categorySlug/:slug" element={<JournalArticle />} />
