...
export const CALC_CONTENT = {
  ...
  "weight-loss-goal": {
    ...
    metaDescription: "Estimate the time to reach a goal weight from your current weight using an adjustable calorie-deficit assumption.",
    intro: "Use this weight loss goal calculator to estimate the difference between your current and goal weight and the approximate timeline under a moderate calorie-deficit assumption.",
    overview: "The calculator subtracts your goal weight from your current weight and estimates a timeline using the selected daily energy-deficit assumption. A 500 kcal/day deficit is a simple planning model, not a promise of a fixed weekly loss.",
    steps: ["Enter your current weight.", "Enter your goal weight.", "Calculate the amount of weight that would need to be lost.", "Apply the calculator's estimated weekly loss from the assumed calorie deficit.", "Use the timeline as a planning estimate and reassess progress over time."],
    faq: [
      { q: "How long will it take to reach my goal weight?", a: "The calculator provides a theoretical estimate from the weight difference and assumed rate. Real progress varies because energy expenditure, adherence, water weight, and metabolism change over time." },
      { q: "Is a 500 calorie deficit appropriate for everyone?", a: "No. Calorie needs and appropriate deficits vary by person. Very large deficits may be inappropriate, particularly for people who are underweight, adolescents, pregnant people, or those with medical conditions." },
      { q: "How much weight loss per week is realistic?", a: "A gradual rate is generally easier to sustain than rapid loss. Individual targets should account for starting weight, health, nutrition, activity, and professional advice when needed." },
      { q: "Why is my actual weight loss different from the estimate?", a: "Scale weight includes water, glycogen, food contents, and lean tissue as well as fat. Your energy expenditure can also change as body weight changes." },
      { q: "Should I change my calorie target as I lose weight?", a: "Possibly. Energy needs can fall as body weight decreases, so maintenance calories may need to be reassessed rather than assuming the original deficit remains constant." },
      { q: "Can I use this calculator with exercise?", a: "Yes, but the simple timeline does not precisely model every change in exercise energy expenditure. Use your real-world weight trend to evaluate progress." }
    ],
    limitations: "This is a planning estimate, not a guaranteed timeline or medical prescription. Actual weight change is nonlinear and can differ substantially from a simple calorie-to-weight model."
  },
  "weight-gain-goal": {
  ...
  "ponderal-index": {
    title: "Ponderal Index Calculator", metaDescription: "Ponderal Index — a BMI alternative that works better at extreme heights.", intro: "PI divides weight by height cubed instead of squared, producing a more consistent score across heights.", steps: ["PI = weight / height³ (in meters)."], faq: [{ q: "When is PI better than BMI?", a: "For very tall or very short adults." }]
  },
  "adjusted-body-weight": {
    title: "Adjusted Body Weight Calculator", metaDescription: "Compute AdjBW — used for medication dosing in overweight patients.", intro: "AdjBW splits the difference between ideal and actual weight for more accurate clinical dosing.", steps: ["Compute IBW.", "AdjBW = IBW + 0.4·(actual − IBW)."], faq: [{ q: "When is AdjBW used?", a: "When actual weight is more than 20–30% above IBW." }]
  },
  "body-density": {
    title: "Body Density Calculator (Siri)", metaDescription: "Estimate body density from body fat percentage using the Siri equation.", intro: "Body density relates fat percentage to overall body composition. Denser = leaner.", steps: ["Estimate body fat %.", "BD = 495 / (BF% + 450)."], faq: [{ q: "What is a healthy body density?", a: "Roughly 1.04–1.08 g/mL for most adults." }]
  },
  "obesity-class": {
