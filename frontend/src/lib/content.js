...
export const CALC_CONTENT = {
  ...
  "weight-loss-goal": {
    ...
    steps: ["Enter your current weight.", "Enter your goal weight.", "Calculate the amount of weight you want to lose.", "Apply the calculator's estimated weekly loss from the assumed calorie deficit.", "Use the timeline as a planning estimate and reassess progress over time."],
    faq: [
