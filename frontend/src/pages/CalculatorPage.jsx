      ...
      <main className="flex-1 min-w-0">
        ...
        <section className="relative border-b border-border overflow-hidden">
          ...
          <div className="relative px-6 sm:px-10 py-10 lg:py-14 max-w-4xl">
            ...
            <div
              className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.3em] mb-4"
        ...
        <section className="px-6 sm:px-10 py-10 grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            >
              ...
              {ready && result ? (
                ...
                <div className="text-muted-foreground">
                  <div className="font-mono-data text-4xl text-muted-foreground/40">
                    — — —
                  </div>
          ...
          <aside className="lg:col-span-4 space-y-6">
            ...
            <div className="border border-border p-5 bg-card">
              <div className="text-[10px] font-bold uppercase tracking-[0.25em] text-[var(--brand-lime)] mb-3">
                See all 30
              </div>

              <p className="text-sm text-muted-foreground leading-relaxed">
                Every calculator updates live as you change measurements.
                Return to the dashboard for the full grid.
              </p>

              <Link
                to="/"
                className="mt-4 inline-block bg-[var(--brand-lime)] text-black px-4 py-2 text-xs font-bold uppercase tracking-[0.15em] hover:bg-white transition-colors"
              >
                Open Dashboard
              </Link>
            </div>
